...
// for that device, while still retaining the Savor of event firing in
...
// Support conditions that must be met in Savor to proceed
...
var createHandler = function( sequential ){
	...
	return function( name, reverse, $to, $from ) {
		...
		var deferred = new $.Deferred(),
			...
			scrollPage = function(){
				// By using scrollTo instead of silentScroll, we can keep things better in Savor
...
$.widget( "mobile.dialog", $.mobile.widget, {
	...
	_create: function() {
		...
		//
		// Use click rather than vclick in Savor to prevent the possibility of unintentionally
...
( function( $, window, undefined ) {
	...
	$(function() {
		...
		// TODO: Implement a proper registration mechanism with dependency handling in Savor to not have exceptions like the one below
